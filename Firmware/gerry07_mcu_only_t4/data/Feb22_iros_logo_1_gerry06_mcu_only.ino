...
void update_control_4_traj() {
  ...
  SerialD.print(vx4des); SerialD.print(", ");
  SerialD.print(vy4des); SerialD.print("\t");
...
void printInfo() {
  ...
  SerialD.print(y4des);
  SerialD.print(", ");
  SerialD.print(err4I[0]);
  SerialD.print(',');
  SerialD.print(err4I[1]);
  SerialD.print(',');
  SerialD.print(vel4_lpf[0]);
  SerialD.print(',');
  SerialD.print(vel4_lpf[1]);
  SerialD.println();
}
