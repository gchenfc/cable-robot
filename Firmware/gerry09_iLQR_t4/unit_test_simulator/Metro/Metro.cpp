...
// New creator so I can use either the original check behavior or
// benjamin.soelberg's suggested one (see below). autoreset = 0 is
// benjamin.soelberg's check behavior autoreset != 0 is the original behavior
...
void Metro::reset() { this->previous_millis = millis(); }
